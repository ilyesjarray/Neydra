...
export function NeydraPayment() {
  ...
  <div className="payment-container">
    <h1>Buy Your Plan</h1>
    <p className="subtitle">Secure, crypto subscription .</p>

    <div className="plan-card">
      <div className="plan-title" id="displayPlanName">LOADING...</div>
      <div className="plan-price" id="displayPrice">$0</div>
    ...
    <script src="/neydrapayment.js" defer></script>
