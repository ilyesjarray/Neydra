...
export function NeydraP2P() {
            ...
            <div className="auth-container">
                ...
                <div className="panel">
                    ...
                    <div id="login-form">
                        ...
                        <button className="btn" onClick="handleLogin()">ACCESS SYSTEM</button>
        ...
        <div id="create-view" className="view">
            ...
            <div className="panel" style={{ "maxWidth": "600px", "margin": "0 auto" }}>
                ...
                <div style={{ "display": "flex", "gap": "10px", "marginTop": "20px" }}>
                    <button className="btn btn-outline" onClick="showView('market-view')">CANCEL</button>
                    <button className="btn" onClick="createOffer()">PUBLISH</button>
                </div>
        ...
        <div id="dash-view" className="view">
            ...
            <div className="dashboard-grid">
                ...
                <div className="dashboard-card">
                    ...
                    <button className="btn btn-sm btn-outline" onClick="showView('create-view')" style={{ "marginTop": "15px" }}>+
                        NEW OFFER</button>
                </div>
                ...
                <div className="dashboard-card">
                    ...
                    <button className="btn btn-sm btn-success" onClick="openStoreModal()" style={{ "marginTop": "15px" }}
    ...
    <div className="notification-panel" id="notif-panel">
        <div className="notification-header">
            ...
            <button className="close-btn" onClick="closeNotifPanel()"><i className="ri-close-line"></i></button>
        </div>
    ...
    <div className="modal" id="store-modal">
        <div className="modal-header">
            ...
            <button className="close-btn" onClick="closeModal('store-modal')"><i className="ri-close-line"></i></button>
        </div>
        <div className="modal-body">
            ...
            <button className="btn btn-success" onClick="initiateStorePayment()">PAY 30 TND & CREATE</button>
        </div>
    </div>
    ...
    <div className="modal" id="trade-modal">
        <div className="modal-header">
            ...
            <button className="close-btn" onClick="closeModal('trade-modal')"><i className="ri-close-line"></i></button>
        </div>
    ...
    <div className="modal" id="release-modal">
        <div className="modal-header">
            ...
            <button className="close-btn" onClick="closeModal('release-modal')"><i className="ri-close-line"></i></button>
        </div>
        <div className="modal-body" id="release-body"></div>
    </div>

    <div className="overlay" id="overlay" onClick="closeAllModals()"></div>
    <div className="toast-container" id="toast-cont"></div>

    <nav className="bottom-nav" style={{ "display": "none" }}>
        <ul>
            <li><a href="#" onClick="showView('market-view'); return false;" id="nav-market" className="active"><i
                        className="ri-store-line"></i><span>MARKET</span></a></li>
            <li><a href="#" onClick="showView('create-view'); return false;" id="nav-create"><i
                        className="ri-add-circle-line"></i><span>SELL</span></a></li>
            <li><a href="#" onClick="showView('dash-view'); return false;" id="nav-dash"><i
                        className="ri-user-line"></i><span>PROFILE</span></a></li>
            <li><a href="#" onClick="openNotifPanel(); return false;" style={{ "position": "relative" }}><i
