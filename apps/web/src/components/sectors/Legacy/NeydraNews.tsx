...
export function NeydraNews() {
        ...
        <div className="sidebar-left">
            ...
            <div className="panel" style={{ "flex": "0 0 auto" }}>
                ...
                <div className="panel-content">
                    <div className="control-row" style={{ "flexWrap": "wrap", "gap": "4px" }}>
                        <button id="cat-world" className="active" onClick="toggleCategory('world')">WORLD</button>
                        <button id="cat-tech" onClick="toggleCategory('technology')">TECH</button>
                        <button id="cat-business" onClick="toggleCategory('business')">BIZ</button>
                        <button id="cat-science" onClick="toggleCategory('science')">SCI</button>
                        <button id="cat-health" onClick="toggleCategory('health')">HEALTH</button>
                        <button id="cat-politics" onClick="toggleCategory('politics')">POL</button>
                        <button id="cat-sports" onClick="toggleCategory('sports')">SPORT</button>
                    </div>
                </div>
            </div>
            <!-- LIVE TV PANEL -->
            <div className="panel live-tv-panel" style={{ "flex": "1", "minHeight": "0" }}>
                ...
                <div className="tv-tabs" id="tv-tabs">
                    <div className="tv-tab active" onClick="switchTV(0)">AJ EN</div>
                    <div className="tv-tab" onClick="switchTV(1)">FR24 EN</div>
                    <div className="tv-tab" onClick="switchTV(2)">DW</div>
                    <div className="tv-tab" onClick="switchTV(3)">AJ AR</div>
                </div>
            ...
            <div className="panel" style={{ "flex": "0 0 auto" }}>
                ...
                <div className="controls">
                    <div className="control-row"><button onClick="refreshNews()">⟳ REFRESH</button><button className="secondary"
                            onClick="showSettings()">⚙ SETTINGS</button></div>
                    <div className="control-row"><button id="btn-breaking" onClick="toggleBreakingOnly()">BREAKING
                            ONLY</button></div>
                    <div className="control-row"><button onClick="showHowToUse()">? HOW TO USE</button><button
                            className="secondary" onClick="showLegacyConnect()">LEGACY MODE</button></div>
                </div>
        ...
        <div className="main-view">
            <div className="earth-container panel">
                ...
                <div className="breaking-alert" id="breaking-alert">
                    ...
                    <button className="breaking-close" onClick="closeAlert()">X</button>
        ...
        <div className="sidebar-right" id="sidebar-right">
            <div className="panel news-feed">
                ...
                <div className="lang-switcher">
                    ...
                    <button className="lang-btn" onClick="switchLang('ar')">AR</button>
                    <button className="lang-btn" onClick="switchLang('es')">ES</button>
                    <button className="lang-btn" onClick="switchLang('de')">DE</button>
                </div>
    ...
    <div className="country-popup" id="country-popup">
        <div className="country-popup-content">
            <div className="country-popup-header">
                ...
                <button className="country-popup-close" onClick="closeCountryPopup()">X</button>
            </div>
    ...
    <div className="connection-overlay" id="connection-overlay">
        <div className="connection-panel">
            ...
            <button className="close-btn" onClick="hideLegacyConnect()" style={{ "color": "#000", "borderColor": "#000" }}>X</button>
            <div className="inner">
                ...
                <button onClick="initializeConnection()" style={{ "width": "100%", "padding": "15px" }}>CONNECT</button>
                ...
                <button onClick="hideLegacyConnect()" style={{ "width": "100%", "marginTop": "10px", "padding": "10px" }}
    ...
    <div className="how-to-use-overlay" id="how-to-use-overlay">
        <div className="how-to-use-panel">
            ...
            <button className="close-btn" onClick="hideHowToUse()">X</button>
            <div className="how-to-use-content">
                ...
                <div style={{ "textAlign": "center", "marginTop": "30px" }}>
                    <button onClick="hideHowToUse()" style={{ "width": "auto", "padding": "15px 50px", "fontSize": "18px" }}>CONTINUE
                        TO DASHBOARD</button>
                </div>
            </div>
        </div>
    ...
    <div className="settings-overlay" id="settings-overlay">
        <div className="settings-panel">
            <button className="close-btn" onClick="hideSettings()"
            ...
            <button onClick="saveSettings()" style={{ "width": "100%", "marginTop": "8px" }}>SAVE SETTINGS</button>
        </div>
    </div>
