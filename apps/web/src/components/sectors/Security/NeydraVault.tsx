...
export function NeydraVault() {
    ...
    const fetchVaultItems = async () => {
        ...
        if (session) {
            ...
            if (profile) {
                setUserData({
                    name: profile.username || session.user.email?.split('@')[0] || 'NEYDRA',
                                ...
                                <div className="flex-1 p-14 flex flex-col justify-between">
                                    <div className="flex justify-between items-start">
                                        <div className="space-y-3">
                                            ...
                                            <h2 className="text-5xl font-black text-white italic tracking-tighter uppercase leading-none">Neydra Passport</h2>
                            ...
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    <h1 className="text-5xl font-black text-white italic tracking-tighter uppercase leading-none">
                                        Neydra Vault <span className="text-hyper-cyan font-mono border-l border-white/20 pl-4 ml-4">2.0</span>
                                    </h1>
