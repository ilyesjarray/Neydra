...
export function NeydraSettings() {
    ...
    const [neydraCredits, setNeydraCredits] = useState(0);
    ...
    const loadSettings = async () => {
        ...
        if (session) {
            ...
            if (profile && !error) {
                ...
                setNeydraCredits(profile.neydra_credits || 0);
            } else {
                            ...
                            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                                <div className="glass-v-series p-10 rounded-3xl border border-neydra-accent/30 bg-neydra-accent/[0.02]">
                                    ...
                                    <p className="text-xs text-white/50 mb-8 max-w-lg leading-relaxed font-bold uppercase tracking-widest">
                                        Unlock the full potential of NEYDRA OS. Gain access to the AI Auto-Broker, Syndicate Creation, and Zero-Knowledge Enterprise Vault.
                                    </p>
