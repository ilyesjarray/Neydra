        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
                <motion.div
                    ...
                    className="max-w-xl w-full prestige-panel p-10 rounded-3xl border-neydra-accent-gold/40 shadow-[0_0_50px_rgba(251,191,36,0.2)] relative overflow-hidden"
                >
                    <div className="diamond-dust" />

                    <div className="relative z-10 text-center space-y-6">
                        <div className="flex justify-center">
                            <div className="w-16 h-16 rounded-2xl bg-neydra-accent-gold/10 border border-neydra-accent-gold/30 flex items-center justify-center text-neydra-accent-gold">
                        ...
                        <div className="space-y-4 text-left bg-black/30 p-6 rounded-2xl border border-white/5">
                            <div className="flex gap-3">
                                <ShieldAlert className="w-5 h-5 text-neydra-accent-gold shrink-0 mt-1" />
                        ...
                        <button
                            ...
                            className="w-full py-4 bg-neydra-accent-gold text-black font-bold rounded-xl hover:bg-yellow-500 transition-all flex items-center justify-center gap-2 group shadow-[0_0_20px_rgba(251,191,36,0.2)]"
                        >
