...
export function NeydraSplash({ onComplete }: NeydraSplashProps) {
    ...
    const handleDownloadResources = async () => {
        ...
        try {
            ...
            const cache = await caches.open('neydra-assets-v1');
