...
export function BiometricLogin({ onSuccess }: BiometricLoginProps) {
    ...
    return (
        <div className={`relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-black ${glitchActive ? 'animate-pulse scale-[1.02]' : ''}`}>
                    ...
                    <AnimatePresence>
                        {scanComplete && (
                            <motion.div
                                ...
                                animate={{ opacity: 1, scale: 1 }}
                                className="absolute inset-0 bg-neydra-blue/10 flex items-center justify-center flex-col gap-8 z-20 backdrop-blur-md"
                            >
                                <motion.div
                                    animate={{
                                        scale: [1, 1.1, 1],
                                ...
                                >
                                    <Shield className="w-12 h-12 text-neydra-blue" />
                                </motion.div>
                                <div className="text-center">
                                    <span className="text-[11px] font-black text-neydra-blue tracking-[0.6em] uppercase block mb-2">ACCESS_GRANTED</span>
            ...
            <div className="absolute bottom-0 left-0 w-[800px] h-[800px] bg-neydra-blue/5 blur-[160px] rounded-full pointer-events-none" />
        </div>
    );
}
