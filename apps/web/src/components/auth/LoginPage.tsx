...
export default function LoginPage() {
    ...
    const handleWeb3Login = async () => {
        try {
            ...
            const message = `NEYDRA OS Authentication.\nTimestamp: ${Date.now()}\nAddress: ${address}`;
            await signer.signMessage(message);

            // Use the address to create a seamless account via Supabase
            const web3Email = `${address.toLowerCase()}@web3.neydra.os`;
                ...
                <div className="relative z-10 space-y-8">
                    <div>
                        ...
                        <p className="text-base leading-relaxed max-w-sm" style={{ color: 'var(--ivory-dim)' }}>
                            ...
                            directly into your hands. One platform. Infinite neydraty.
                        </p>
                    </div>
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-sm" style={{ color: 'var(--ivory-dim)' }}>
                                        Enter your credentials to access NEYDRA OS.
                                    </p>
                                </div>

                                <form onSubmit={handleEmailLogin} className="space-y-4">
                                    <div>
                                        <label className="neydra-label">Email Address</label>
                                        <input
                                            type="email"
                                            className="neydra-input"
                                    ...
                                    <div>
                                        <label className="neydra-label">Password</label>
                                        <input
                                            type="password"
                                            className="neydra-input"
                                            placeholder="••••••••"
                                    ...
                                    <button
                                        ...
                                        className="neydra-btn neydra-btn-primary w-full py-3.5 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                    >
                        ...
                        {mode === 'register' && (
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-sm" style={{ color: 'var(--ivory-dim)' }}>
                                        Register to gain access to NEYDRA OS.
                                    </p>
                                </div>

                                <form onSubmit={handleEmailRegister} className="space-y-4">
                                    <div>
                                        <label className="neydra-label">Full Name</label>
                                        <input
                                            type="text"
                                            className="neydra-input"
                                    ...
                                    <div>
                                        <label className="neydra-label">Password (8+ characters)</label>
                                        <input
                                            type="password"
                                            className="neydra-input"
                                            placeholder="••••••••"
                        ...
                        {mode === 'choose' && (
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-sm" style={{ color: 'var(--ivory-dim)' }}>
                                        Sign in to initialize your neydra operations.
                                    </p>
                                </div>
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    className="neydra-btn neydra-btn-primary w-full text-base py-3.5 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {loading ? (
                                ...
                                <button
                                    ...
                                    className="neydra-btn neydra-btn-ghost w-full text-sm py-3"
                                >
                                ...
                                <button
                                    ...
                                    className="neydra-btn neydra-btn-ghost w-full text-sm py-3 border border-white/10"
                                >
                            ...
                            >
                                ...
                                <form onSubmit={handleMagicLink} className="space-y-4">
                                    ...
                                    <button
                                        ...
                                        className="neydra-btn neydra-btn-primary w-full py-3.5 disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        {loading ? (
                                            <Loader2 className="w-5 h-5 animate-spin" />
                                        ) : (
