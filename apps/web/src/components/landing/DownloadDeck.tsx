...
export function DownloadDeck() {
    ...
    const handleDownload = () => {
        ...
        link.href = '/neydra_sales_deck.pdf'; // This will be simulated or the developer will provide the actual asset
        link.download = 'neydra_sales_deck.pdf';
        link.click();
    };
                    ...
                    <div className="grid md:grid-cols-2 gap-20 items-center">
                        <div className="space-y-10">
                            ...
                            <p className="text-white/40 text-lg font-bold italic leading-relaxed uppercase">
                                Access the full technical and financial breakdown of NEYDRA IP assets. Learn why our reality-infusion engine is the next paradigm in business intelligence.
                            </p>
                        ...
                        <div className="flex flex-col gap-8">
                            <div className="p-10 bg-carbon-black/60 rounded-[2.5rem] border border-white/5 space-y-8 backdrop-blur-3xl shadow-2xl">
                                ...
                                <p className="text-center text-[8px] text-white/10 uppercase tracking-widest font-mono italic">
                                    By submitting, you agree to the NDA and standard Neydra Protocol terms.
                                </p>
                            </div>
                        </div>
                    </div>
