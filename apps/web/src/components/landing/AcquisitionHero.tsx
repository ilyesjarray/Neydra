...
export function AcquisitionHero() {
    ...
    return (
        <section className="relative min-h-screen flex flex-col items-center justify-center p-10 overflow-hidden bg-carbon-black">
            ...
            {/* Glowing Aura */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-neydra-accent/5 rounded-full blur-[120px] pointer-events-none" />
            ...
            <div className="max-w-6xl w-full relative z-10 text-center space-y-12">
                ...
                >
                    <div className="flex items-center gap-4 px-6 py-2 rounded-full border border-neydra-accent/20 bg-neydra-accent/5 backdrop-blur-xl">
                        <ShieldCheck className="w-4 h-4 text-neydra-accent animate-pulse" />
                        <span className="text-[10px] font-black text-neydra-accent uppercase tracking-[0.5em] font-mono">
                    ...
                    <h1 className="text-8xl md:text-9xl font-black text-white italic tracking-tighter uppercase leading-[0.85] text-balance">
                        ...
                        <span className="text-neydra-accent drop-shadow-neon-red">Neydra Intelligence</span>
                    </h1>
                ...
                >
                    <button className="group relative px-16 py-8 bg-neydra-accent text-carbon-black rounded-[2rem] font-black text-lg uppercase tracking-[0.4em] shadow-neon-red hover:bg-white transition-all italic overflow-hidden">
                ...
                >
                    {[
                        ...
                        <div key={i} className="flex flex-col items-center gap-4 p-8 glass-v-series rounded-[2.5rem] bg-white/[0.01] border border-white/5 group hover:border-neydra-accent/20 transition-all">
                            <item.icon className="w-10 h-10 text-white/10 group-hover:text-neydra-accent transition-colors" />
