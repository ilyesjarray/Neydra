...
export function ComingSoon({ sectorName }: ComingSoonProps) {
    return (
        <div className="flex-1 flex items-center justify-center relative overflow-hidden bg-carbon-black p-10 font-sans">
            ...
            {/* Glowing Pulse */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-neydra-accent/5 rounded-full blur-[120px] animate-pulse pointer-events-none" />
            ...
            <div className="relative z-10 flex flex-col items-center max-w-2xl w-full">
                ...
                <div className="relative mb-12">
                    <motion.div
                        ...
                        className="w-48 h-48 border-2 border-neydra-accent/20 rounded-[2.5rem] flex items-center justify-center relative"
                    >
                        <div className="absolute inset-0 border-t-2 border-neydra-accent rounded-[2.5rem] animate-spin-slow opacity-60 shadow-neon-red" />
                        <motion.div
                            animate={{ opacity: [0.3, 1, 0.3] }}
                            transition={{ duration: 2, repeat: Infinity }}
                        >
                            <Hammer size={64} className="text-neydra-accent" />
                        </motion.div>
                    </motion.div>
                    ...
                    >
                        <Cpu size={20} className="text-neydra-accent/40" />
                    </motion.div>
                    <motion.div
                        animate={{ y: [0, 15, 0], x: [0, -10, 0] }}
                    ...
                    >
                        <Zap size={20} className="text-red-500/40" />
                    </motion.div>
                </div>

                <div className="text-center space-y-6">
                    <div className="inline-flex items-center gap-3 px-4 py-1.5 bg-neydra-accent/10 border border-neydra-accent/20 rounded-full">
                        <span className="w-2 h-2 bg-neydra-accent rounded-full animate-pulse shadow-neon-red" />
                        <span className="text-[10px] font-black text-neydra-accent uppercase tracking-[0.4em] font-mono">Construction_Protocol_Active</span>
                    </div>
                    ...
                    <p className="text-sm text-white/20 uppercase tracking-widest leading-relaxed max-w-lg mx-auto font-mono">
                        Our neural engineering team is currently assembling the <span className="text-neydra-accent/60">{sectorName}</span> sector. 
                    ...
                    <div className="w-full max-w-md mx-auto pt-10 space-y-3">
                        <div className="flex justify-between items-end">
                            ...
                            <span className="text-xs font-black text-neydra-accent italic">84.2%</span>
                        </div>
