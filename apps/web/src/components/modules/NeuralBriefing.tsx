...
export function NeuralBriefing({ onClose }: NeuralBriefingProps) {
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 opacity-10 bg-[linear-gradient(rgba(255,0,0,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(255,0,0,0.1)_1px,transparent_1px)] bg-[size:100px_100px]" />

            <div className="relative max-w-4xl w-full space-y-12">
                {/* Loading Sequence */}
                {step < steps.length - 1 && (
                    <div className="flex flex-col items-center justify-center space-y-8">
                        <div className="w-24 h-24 rounded-full border-2 border-neydra-accent/20 border-t-neydra-accent animate-spin" />
                        <div className="text-center space-y-2">
                            <h2 className="text-2xl font-black text-white italic tracking-[0.2em]">{steps[step].title}</h2>
                            <p className="text-[10px] text-neydra-accent uppercase font-mono tracking-widest">{steps[step].label}</p>
                        </div>
                    </div>
                )}
                ...
                {step === steps.length - 1 && (
                    ...
                    >
                        <div className="flex justify-between items-start border-b border-white/5 pb-8">
                            <div className="space-y-2">
                                <div className="flex items-center gap-3">
                                    <div className="p-2 rounded-lg bg-neydra-accent/20 border border-neydra-accent/40">
                                        <Zap className="w-6 h-6 text-neydra-accent" />
                                    </div>
                            ...
                            <button
                                onClick={onClose}
                                className="p-4 bg-white/5 border border-white/10 rounded-2xl hover:bg-red-600/10 hover:border-red-600/40 text-white/20 hover:text-red-600 transition-all"
                            >
                                <X size={24} />
                            </button>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8 text-left">
                            ...
                            <div className="p-8 bg-white/[0.03] border border-white/10 rounded-3xl space-y-4 relative overflow-hidden group">
                                <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:scale-110 transition-transform">
                                    <ShieldCheck size={80} className="text-neydra-accent" />
                                </div>
                                <div className="flex items-center gap-3 text-neydra-accent">
                                    <Cpu size={18} />
                            ...
                            <div className="p-8 bg-white/[0.03] border border-white/10 rounded-3xl space-y-4 relative overflow-hidden group">
                                <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:scale-110 transition-transform">
                                    <Volume2 size={80} className="text-neydra-accent" />
                                </div>
                                <div className="flex items-center gap-3 text-neydra-accent">
                                    <Target size={18} />
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div className="flex-1 h-1 bg-white/5 rounded-full overflow-hidden">
                                            <div
                                                className="h-full bg-neydra-accent shadow-neon-red transition-all duration-1000"
                        ...
                        {/* Strategic Advice (AI) */}
                        <div className="p-10 bg-gradient-to-br from-neydra-accent/10 to-transparent border-2 border-neydra-accent/30 rounded-[3rem] space-y-6 relative overflow-hidden">
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 rounded-full border border-neydra-accent bg-neydra-accent/20 flex items-center justify-center animate-pulse">
                                    <Volume2 className="text-neydra-accent w-6 h-6" />
                                </div>
                                <div>
                                    <span className="text-[10px] font-black text-neydra-accent uppercase tracking-[0.3em]">Neural_Advisory</span>
                        ...
                        <button
                            onClick={onClose}
                            className="w-full py-8 bg-white text-carbon-black rounded-[2.5rem] font-black text-xs uppercase tracking-[0.8em] hover:bg-neydra-accent hover:shadow-neon-red transition-all flex items-center justify-center gap-4 group"
                        >
                            Enter_Neydra_Command
