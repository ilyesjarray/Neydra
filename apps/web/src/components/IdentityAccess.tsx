...
export function IdentityAccess({ onSectorChange }: IdentityAccessProps) {
    ...
    const handleSignOut = async () => {
        ...
        localStorage.removeItem('neydra_intro_played');
        setIsOpen(false);
        router.push('/');
        router.refresh();
    };
    ...
    const menuItems = [
        { label: 'Security Clearance', icon: Shield, href: '#', desc: 'Manage access levels', id: 'neydra-vault', menuKey: 'security-clearance' },
