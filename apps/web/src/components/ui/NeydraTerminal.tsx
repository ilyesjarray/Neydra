...
export function NeydraTerminal() {
    const [isOpen, setIsOpen] = useState(false);
    const [input, setInput] = useState('');
    const [logs, setLogs] = useState<string[]>(['[SYSTEM_AUTH] NEYDRA_INTELLIGENCE_LAYER_V4_READY', '[CMD_LINK] ENCRYPTED_OVERLAY_SYNCHRONIZED']);
