...
export async function POST(request: Request) {
    try {
        ...
        // We append nologo=true to keep it professional for NEYDRA OS
        ...
        console.log(`[Neydra Neural Proxy] Synthesizing via Pollinations: ${targetUrl}`);
        ...
        console.error('[Neydra Neural Proxy] Error:', error);
