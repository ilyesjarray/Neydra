...
export async function POST(req: Request) {
    ...
    try {
        ...
        for (const item of topNews) {
            const prompt = `Analyze this news and rewrite it as a 'Neydra Intelligence Briefing' in a concise, urgent, and highly professional tone (max 40 words). Mention any potential market impact. 
