...
<body>
  <div class="container">
    <div class="header">
      <div class="logo">THE_NEYDRA_Ω</div>
    ...
    <div class="footer">
      NEYDRA_OS // CLASSIFIED_LEVEL_4 // © ${new Date().getFullYear()}<br/>
    ...
    try {
        const res = await fetch('https://api.resend.com/emails', {
            ...
            body: JSON.stringify({
                from: 'NEYDRA OS <intel@yourdomain.com>',
                to: [email],
                subject: `[NEYDRA] Daily Intelligence Brief — ${new Date().toLocaleDateString('en-US')}`,
                html: htmlBody,
            }),
        });
