...
export const MarketProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    useEffect(() => {
        const connect = () => {
            console.log('[Neydra] Initializing Financial Data Stream...');

            const socket = new WebSocket(BINANCE_WS_URL);
            socketRef.current = socket;

            socket.onopen = () => {
                console.log('[Neydra] Data Stream Established.');
            ...
            socket.onmessage = (event) => {
                try {
                    ...
                    console.error('[Neydra] Stream Parse error:', error);
                }
            };
            ...
            socket.onclose = () => {
                ...
                console.warn(`[Neydra] Stream Closed. Retrying in ${backoff}ms (Attempt ${retryCount.current + 1})`);
            ...
            socket.onerror = (error) => {
                console.error('[Neydra] Stream Error:', error);
                socket.close();
            };
        };
