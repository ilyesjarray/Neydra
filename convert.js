...
const dirsToConvert = [
    { dir: 'account', name: 'NeydraAccount' },
    { dir: 'exchange', name: 'NeydraExchange' },
    { dir: 'news', name: 'NeydraNews' },
    { dir: 'nexhub', name: 'NeydraNexhub' },
    { dir: 'nlp', name: 'NeydraNLP' },
    { dir: 'pae', name: 'NeydraPAE' },
    { dir: 'shop', name: 'NeydraShop' },
    { dir: 'p2p', name: 'NeydraP2P' },
    { dir: 'payment', name: 'NeydraPayment' }
];
